...
#ifndef RIASSUNTI_PDF_SWIFT_H
#define RIASSUNTI_PDF_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="riassunti_pdf",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13riassunti_pdf11AppDelegate")
...
SWIFT_CLASS("_TtC13riassunti_pdf17MainFlutterWindow")
